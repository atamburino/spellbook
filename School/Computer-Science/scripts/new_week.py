...
def main() -> None:
    ...
    parser.add_argument("--course", required=True, type=normalize_course, help="Course code, such as CS-530.")
    parser.add_argument("--week", required=True, type=int, help="Week number (1 or greater).")
